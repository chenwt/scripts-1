...
usage = "python "+sys.argv[0]+" -f <file:full path of cnv level3 files,one each line> -g <file: gene file with position inform; gene,chr,start,end,strand> -o <filename: output file name>"
