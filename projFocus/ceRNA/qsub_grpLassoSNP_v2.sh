...
#Desp: compared to v1, submit jobs according to number of genes
...
#script="/ifs/home/c2b2/ac_lab/jh3283/scripts/projFocus/ceRNA/grpLassoSNP_v2.r"
...
do
  ...
  cmd="${Rscript} ${script} ${genesnpFile} ${geneexpFile} ${genecnvFile} 1" 
  #echo $cmd
  echo $cmd |qsub -l mem=4g,time=4:: -N "chr"${chr}_${gene} -e ${logdir} -o ${logdir} -cwd >> ${logdir}"/qsub_log"
  #$cmd
