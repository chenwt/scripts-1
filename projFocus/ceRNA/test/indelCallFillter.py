#!/usr/bin/env python
#input: 1.< full path of VCF file >
#	2.< full path of output VCF file>
#output: 1.<file: vcf after filtering> 
#desp: created for projFocus, filtering VCFs created by dindel,
...
usage="Usage: indelFilter.py -i <input.VCF> -o <output.VCF>"
example="Example:" 
argv = sys.argv[1:]
try:
...
for opt,arg in opts:
      if opt == "-h":
            print "Error Command line parameter; Usage: do_final_filter.py -i input.vcf -o out.tsv"
      elif opt == "-i":
            inp = arg
      elif opt == "-o":
            out = arg
