#!/usr/bin/python
#J.HE
#desp.: parsing downloaded file from refseq, get single tss, 3'UTR or 5'UTR
# coordinates,  
#input: 
...
outputTsstseH = open(output+"_Tsstse.tsv",'w+')
...
with open(input) as f:
    ...
    while line:
        ...
        if geneSymbol:
            ...
            outputTsstseH.write("\t".join([geneSymbol, chrom, tss,\
                                        tse, strand]) + "\n")
