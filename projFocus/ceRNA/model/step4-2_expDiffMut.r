...
driMutfile = "/Volumes/ifs/data/c2b2/ac_lab/jh3283/projFocus/result/05012014/sigMut/test/test_optCorr_05062014_1_regMut.temp.txt.fullMatrix"
...
cls.all = cutree(hclust(dist(t(expD[,c(smpDrMut,smpNonMut)]))), k = 4)
...
plot(rect.hclust(cls.fit,k=2))

table(cls.all); table(cls)
cls.all[cls.all==3]
smpDrMut
table(cls.all[smpDrMut])
## clustering to select control group
