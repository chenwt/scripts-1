...
output =  "brca_edgeR_deg_02042014"
...
require(gplots)
mycol = bluered(256)
heatmap.2(dataMatVoom$E,col=mycol,trace="none",cexRow=0.3,cexCol=0.3,main="All TCGA cancer Genes")
heatmap.2(dataMatVoomDeg,col=mycol,trace="none",cexRow=0.3,cexCol=0.3, main = "FC>2 TCGA Cancer Genes")
dev.off()
