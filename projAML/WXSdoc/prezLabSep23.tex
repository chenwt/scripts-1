...
\title[Project updates]{Project updates}

\subtitle{AML WXS analysis \\
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
   \frametitle{Reminder \ldots}
   \begin{itemize}
      \item what we have ? 
	      \begin{itemize}
	      	\item16 patients with matched normal, tumor and relapsed sample, whole exome sequencing 
	      \end
	\item what's our hypothesis ?
	  \begin{itemize}
	      	\item MRs related to relapse; mutations related to MRs; 
	  \end
      \item what we've done ? 
      	  \begin{itemize}
	      	\item a list of potential MRs ( Yi shai); somatic mutations and CNVs of the 16 patients
	  \end
   \end{itemize}
\end{frame}
