### Data: expression data matrix with rownames genes, columns as sample
# parameter: clusters want to train,example: start 2, end 30
#			 distance matrix method: euclidean, spearman
#			 linkage methods: min, max,centroid
# usage: myDiBatch(dataMX,2,10,euclidean,max)
# output: data frame with 4 column, k, di, distance method, link method
