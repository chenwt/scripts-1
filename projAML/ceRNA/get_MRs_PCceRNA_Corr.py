...
#		 pccerna database with genename as interactor.
...
pccerna='/ifs/scratch/c2b2/ac_lab/jh3283/database/aclab/huasheng_PC-ceRNET.txt' 

# get pccerna data 
dppi_a = {}
dppi_b = {}
with open(pccerna) as f:
	for line in f:
		[p1, p2] = line.split("\t")
...
outfile = 'MR_mutgene_pccerna.txt' 
outfile2 = 'MR_mutgene_pccerna_ALL.txt' 

fout = open(outfile,'w') 
fout2 = open('MR_mutGene_pccerna_stat.txt','w')
