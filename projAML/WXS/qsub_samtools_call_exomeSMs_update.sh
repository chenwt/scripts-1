...
do
  ...
  echo "~/scripts/projAML/WXS/samtools_call_exomeSMs_stepwise.sh  $bam1 $bam2" |qsub -l mem=8g,time=40:: -N pipeline_${jname1}"_"${jname2} -e ${logd} -o ${logd} -cwd >> $logd/qsub.log
