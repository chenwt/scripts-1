...
#Usage:
#Description:Rscript aracne_cpu_1.r <tumorAcro> <2> <type>
#Note: work under the same directory as the .exp file
 ##--------------------------------------
...
#tumAcro <- "blca"
#num < "1" # specify either first half or second half
#type <- "tf" # specify either tf or sig
...
print "the first part is running.."
