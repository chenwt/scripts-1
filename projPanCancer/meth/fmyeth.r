#' Functional myeths
#' This function identify genes whoes expression is associated with myeth
#' @param myeth: Numeric matrix of myeth quantification (log-ratio)
#' @param threshold: Number indicating the threshold for the myeth , -1 for silencing
#' @param pval Number indicating the p-value threshold for considering a myeth functional
#' @param nn Minimum number of samples harboring a myeth
