...
getEmProb <- function(data,alpha,beta){
	...
	tFreqFile <- gsub("CHR","10","/Volumes/ys_lab_scratch/jh3283/net/AC13/BAF/chrCHR.freq")
	nFreqFile <- gsub("CHR","10","/Volumes/ys_lab_scratch/jh3283/net/AC19/BAF/chrCHR.freq")
myVitebi(tFreqFile,nFreqFile,snp.file)
...
plotVbtStates <- function(vtbStates,delReg) <- 
  plot(vtbStates$Pos,vtbStates,type="l", 
  	main="Viterbi chr10 AC13",xlab="Pos",ylab="States")
  abline(v=39105001,col="red")
  abline(v=135468000,col="red")
